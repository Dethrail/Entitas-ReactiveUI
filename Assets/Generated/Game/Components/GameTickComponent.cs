...
public partial class GameContext {
    ...
    public Entitas_Reactive_UI.Example.TickComponent tick { get { return tickEntity.tick; } }
    public bool hasTick { get { return tickEntity != null; } }

    public GameEntity SetTick(long newCurrentTick) {
        if (hasTick) {
            throw new Entitas.EntitasException("Could not set Tick!\n" + this + " already has an entity with Entitas_Reactive_UI.Example.TickComponent!",
...
public partial class GameEntity {
    ...
    public Entitas_Reactive_UI.Example.TickComponent tick { get { return (Entitas_Reactive_UI.Example.TickComponent)GetComponent(GameComponentsLookup.Tick); } }
    ...
    public void AddTick(long newCurrentTick) {
        ...
        var component = (Entitas_Reactive_UI.Example.TickComponent)CreateComponent(index, typeof(Entitas_Reactive_UI.Example.TickComponent));
